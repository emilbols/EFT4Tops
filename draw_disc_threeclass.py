...
discrTLvsTLR =discr_dict[:,1]/(discr_dict[:,1]+discr_dict[:,2])
discrTLvsTR =discr_dict[:,1]/(discr_dict[:,1]+discr_dict[:,3])
...
EFT_tLR_discr = discr[leftright]
EFT_tR_discr = discr[right]


tL_discr = discrTLvsTR[left]
tR_discr = discrTLvsTR[right]
SM_left_right_discr = discrTLvsTR[SM]
