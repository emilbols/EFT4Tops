...
jets  = Convolution1D(64, 3, kernel_initializer='lecun_uniform',  activation='relu', name='jets_conv0')(jets)
jets = Dropout(dropoutRate)(jets)
jets  = Convolution1D(64, 3, kernel_initializer='lecun_uniform',  activation='relu', name='jets_conv1')(jets)
jets = Dropout(dropoutRate)(jets)
jets  = Convolution1D(32, 1, kernel_initializer='lecun_uniform',  activation='relu', name='jets_conv2')(jets)
jets = Dropout(dropoutRate)(jets)
