...
elec = SortLayer()(elec)
jets = BatchNormalization(momentum=0.6,name='jets_batchnorm')(jets)
muons = BatchNormalization(momentum=0.6,name='muons_batchnorm')(muons)
elec = BatchNormalization(momentum=0.6,name='elec_batchnorm')(elec)
...
jets  = LSTM(50, kernel_initializer='lecun_uniform',  activation='relu', recurrent_dropout=dropoutRate, go_backwards=False, name='jets_lstm')(jets)
jets = Dropout(dropoutRate)(jets)

muons = LSTM(20, kernel_initializer='lecun_uniform',  activation='relu', recurrent_dropout=dropoutRate, go_backwards=False, name='muons_lstm')(muons)
muons = Dropout(dropoutRate)(muons)

elec = LSTM(20, kernel_initializer='lecun_uniform',  activation='relu', recurrent_dropout=dropoutRate, go_backwards=False, name='elec_lstm')(elec)
