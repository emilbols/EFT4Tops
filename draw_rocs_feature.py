...
model = load_model('Feature_extraction/model_checkpoint_save.hdf5')
discr_dict = model.predict(X_test)
print discr_dict.shape
print y_test.shape
x1, y1 = spit_out_roc(discr_dict[:,1], y_test, sm = False)

f = ROOT.TFile("ROCS/Feature_extraction.root", "recreate")
gr1 = TGraph( 100, x1, y1 )
gr1.SetName("roccurve_1")
gr1.Write()
f.Write()
