...
jets  = LSTM(50, kernel_initializer='lecun_uniform',  activation='relu', recurrent_dropout=dropoutRate, go_backwards=True, name='jets_lstm')(jets)
jets = Dropout(dropoutRate)(jets)

muons = LSTM(20, kernel_initializer='lecun_uniform',  activation='relu', recurrent_dropout=dropoutRate, go_backwards=True, name='muons_lstm')(muons)
muons = Dropout(dropoutRate)(muons)

elec = LSTM(20, kernel_initializer='lecun_uniform',  activation='relu', recurrent_dropout=dropoutRate, go_backwards=True, name='elec_lstm')(elec)
