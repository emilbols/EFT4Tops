...
jets  = Convolution1D(128, 1, kernel_initializer='lecun_uniform',  activation='relu', name='jets_conv0')(jets)
jets = Dropout(dropoutRate)(jets)
jets  = Convolution1D(64, 1, kernel_initializer='lecun_uniform',  activation='relu', name='jets_conv1')(jets)
jets = Dropout(dropoutRate)(jets)
jets  = Convolution1D(8, 1, strides = 2, kernel_initializer='lecun_uniform',  activation='relu', name='jets_conv2')(jets)
jets = Dropout(dropoutRate)(jets)
